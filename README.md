...
- **Daily Calendar (日めくりカレンダー)**: Interactive daily calendar with swipe navigation, displaying Eto, Nine Star Ki, Rokuyo, Senjitsu, Moon phase, and 24 Solar Terms
...
- **Sexagenary cycle (十干十二支)**: Calculate the 60-year cycle including Heavenly Stems and Earthly Branches for year, month, and day
- **Nine Star Ki (九星)**: Calculate the Nine Star Ki for year, month, and day based on Setsubun year boundary
- **Rokuyo (六曜)**: Calculate the six-day calendar cycle (先勝、友引、先負、仏滅、大安、赤口)
- **24 Solar Terms (二十四節気)**: Display the current solar term period with exact date detection
- **12 Choku (十二直)**: Calculate the twelve-day calendar cycle
- **Senjitsu (選日)**: Display selected days including Sanrinbō, Ten no Sha, and others
- **Moon Phase (月齢)**: Display lunar age and phase
