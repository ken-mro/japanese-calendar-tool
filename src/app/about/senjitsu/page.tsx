    ...
    >
      ...
      >
        {isJa ? (
          ...
          <>
            <p className="mb-4 text-lg">
              "Senjitsu" refers to a category of selected days in the Japanese
              calendar that indicate specific good or bad fortune, distinct from
              the main cycles like Rokuyo.
            </p>
            <p className="text-lg">
              Days like "Ichiryumanbai-bi" (One Grain Ten Thousand Times Day)
              and "Tensha-nichi" (Heavenly Pardon Day) are considered highly
              auspicious for new beginnings, while others like "Fushoju-nichi"
