    ...
    >
      ...
      >
        {isJa ? (
          ...
          <>
            <p className="mb-4 text-lg">
              Nine Star Ki is a form of astrology that originated in China and
              is widely used in Japan. It uses nine stars derived from your
              birth date to determine your fortune and compatibility.
            </p>
            <p className="text-lg">
              ...
              {NINE_STARS.map((star) => (
                ...
                >
                  ...
                  <td
                    ...
                    data-label={isJa ? "五行" : "Element"}
                  >
                    {isJa ? star.elementKanji : star.element}
                  </td>
                  <td
                    className="text-lg"
                    style={{
                  ...
                  >
                    {isJa ? star.meaningJa : star.meaning}
                  </td>
                </tr>
              ))}
            </tbody>
