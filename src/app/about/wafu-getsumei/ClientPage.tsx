    ...
    >
      ...
      >
        {isJa ? (
          ...
          <>
            <p className="mb-4 text-lg">
              In the traditional Japanese calendar, months are given beautiful
              names that reflect the season rather than just numbers. Examples
              include &quot;Mutsuki&quot; (January) and &quot;Kisaragi&quot;
              (February). These names are still widely used in calendars and
              formal greetings.
            </p>
          </>
        )}
                ...
                return (
                  ...
                  >
                    <td
                      ...
                      data-label={isJa ? "月" : "Month"}
                    >
                      {isJa ? `${index + 1}月` : englishMonths[index]}
                    </td>
                    <td
                      className="font-bold text-2xl"
                      style={{ textAlign: "center", padding: "1.5rem 2.5rem" }}
                      data-label={isJa ? "和風月名" : "Name"}
                    >
                      {month.name}
                    </td>
                    <td
                    ...
                    >
                      {isJa ? month.reading : month.romaji}
                    </td>
                    <td
                      className="text-lg"
                      style={{ textAlign: "left", padding: "1.5rem 2.5rem" }}
                      data-label={isJa ? "意味" : "Meaning"}
                    >
                      {isJa ? month.meaningJa : month.meaning}
                    </td>
                  </tr>
                );
              })}
