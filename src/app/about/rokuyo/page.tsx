        ...
        >
            <div className="description-section" style={{ border: "none", padding: 0 }}>
                {isJa ? (
                    ...
                    <>
                        <p className="mb-4 text-lg">
                            Rokuyo is a six-day cycle used in the Japanese calendar to predict good
                            or bad fortune for the day. It is one of the most popular fortune-telling systems in modern Japan.
                        </p>
                        <p className="text-lg">
                            People often check Rokuyo when planning events like weddings (Taian is preferred) or funerals (Tomobiki is often avoided).
                        </p>
                    </>
                )}
