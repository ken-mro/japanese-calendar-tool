...
export const NINE_STARS = [
  ...
  { number: 2, name: '2 Black Earth', kanji: '二黒土星', reading: 'じこくどせい', romaji: 'Jikoku Dosei', element: 'Earth', elementKanji: '土', color: 'Black', colorKanji: '黒', meaning: 'Nurturing earth, patience, and diligence.', meaningJa: '大地のような育成力、忍耐力、堅実さを象徴する。' },
  { number: 3, name: '3 Blue Wood', kanji: '三碧木星', reading: 'さんぺきもくせい', romaji: 'Sanpeki Mokusei', element: 'Wood', elementKanji: '木', color: 'Blue', colorKanji: '青', meaning: 'Young tree, energy, and new beginnings.', meaningJa: '若木のような活力、雷のような行動力、新規開拓を象徴する。' },
  { number: 4, name: '4 Green Wood', kanji: '四緑木星', reading: 'しろくもくせい', romaji: 'Shiroku Mokusei', element: 'Wood', elementKanji: '木', color: 'Green', colorKanji: '緑', meaning: 'Wind, communication, and maturity.', meaningJa: '風のような往来、整うこと、成熟を象徴する。' },
  { number: 5, name: '5 Yellow Earth', kanji: '五黄土星', reading: 'ごおうどせい', romaji: 'Goou Dosei', element: 'Earth', elementKanji: '土', color: 'Yellow', colorKanji: '黄', meaning: 'Center, governance, and overwhelming power.', meaningJa: '帝王のような支配力、破壊と再生、強力なエネルギーを象徴する。' },
  { number: 6, name: '6 White Metal', kanji: '六白金星', reading: 'ろっぱくきんせい', romaji: 'Roppaku Kinsei', element: 'Metal', elementKanji: '金', color: 'White', colorKanji: '白', meaning: 'Heaven, dignity, and strong will.', meaningJa: '天のような高潔さ、威厳、強い意志を象徴する。' },
  { number: 7, name: '7 Red Metal', kanji: '七赤金星', reading: 'しちせききんせい', romaji: 'Shichiseki Kinsei', element: 'Metal', elementKanji: '金', color: 'Red', colorKanji: '赤', meaning: 'Joy, eloquence, and entertainment.', meaningJa: '悦び、愛嬌、金銭、雄弁さを象徴する。' },
  { number: 8, name: '8 White Earth', kanji: '八白土星', reading: 'はっぱくどせい', romaji: 'Happaku Dosei', element: 'Earth', elementKanji: '土', color: 'White', colorKanji: '白', meaning: 'Mountain, transition, and stability.', meaningJa: '山のような不動心、変化、継承を象徴する。' },
  { number: 9, name: '9 Purple Fire', kanji: '九紫火星', reading: 'きゅうしかせい', romaji: 'Kyushi Kasei', element: 'Fire', elementKanji: '火', color: 'Purple', colorKanji: '紫', meaning: 'Fire, beauty, and intellect.', meaningJa: '火のような情熱、美、知性、離合集散を象徴する。' },
];
